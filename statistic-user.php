...
<main>
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item">Thống kê mua hàng</li>
        </ol>
        <div class="row">
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary text-white mb-4">
                    <div class="card-body"><i class="fas fa-money-bill"></i> Đơn hàng đã mua</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-white mb-4">
                    <div class="card-body"><i class="fas fa-sack-dollar"></i> Số tiền đã trả</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
            ...
            <!-- <div class="col-xl-3 col-md-6">
                <div class="card bg-success text-white mb-4">
                    <div class="card-body"><i class="fas fa-eye"></i> Số lượng món ăn</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
